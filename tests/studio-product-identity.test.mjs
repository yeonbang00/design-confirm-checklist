...
src='const visualTone=(v)=>v||{};const normalizeReferenceStudy=(v)=>v;const REFERENCE_STUDY_PROMPT="reference";const verifiedPageEvidence=()=>({facts:[],offers:[]});const normalizePhotoRegions=()=>[];const rejectIfNotSameOrigin=()=>false;const OPENAI_MODEL="mock";const callOpenAI=async o=>{globalThis.identityPrompt=o.promptText;return globalThis.identityResponse};\n'+src;
