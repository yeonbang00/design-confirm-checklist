...
async function generateImage(plan,run,q){
 ...
 if(plan.completeBanner){variant.textClaims=verifiedText.claims;variant.autoStatus='완성 배너 · 문구·숫자 대조 완료';}
 renderBoard();
