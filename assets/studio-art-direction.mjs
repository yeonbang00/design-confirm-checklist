...
export function artDirect(plans,product){
 ...
 const directions=[
 ['editorial','Ivory editorial. A generous elegant Korean serif headline in a shallow top strip, dominant photograph filling the remaining canvas, small verified information along bottom. No pills or filled CTA buttons.','짧은 브랜드 광고 제목. 패션이면 계절·스타일을 자연스럽게 말한다. 상품명을 제목에 반복하지 않는다.'],
 ...
 ['quiet','Warm architectural sunlight, product or model large. Large restrained Korean serif title in the natural empty space. One small bottom information line. No badges, pills or button bars.','오늘의 컬러처럼 실제 색상이나 일상 스타일에 연결하는 짧은 제목. 보이는 장면을 장황하게 묘사하지 않는다.'],
