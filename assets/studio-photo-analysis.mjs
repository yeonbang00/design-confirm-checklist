...
const FIELDS = ['matchesTarget','assetKind','role', 'hasPerson', 'personKind', 'plainBg', 'shotAngle',
  'shotDistance', 'itemCount', 'isHero', 'isGift', 'colorway', 'burnedText', 'note', 'regions', 'pose', 'light', 'foodState', 'actualPreparedMeal', 'foodUse', 'foodVisualRole', 'packageVisible', 'garmentComplete'];
