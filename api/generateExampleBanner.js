...
const FIXED_PROMPT = '첨부된 기획안(PPT 캡처) 이미지의 내용과 분위기에 어울리는 광고 배너의 러프 목업 이미지를 만들어줘. 기획안 속 실제 문구·가격·로고는 그대로 옮기지 말고, 텍스트는 최소화하거나 의미 없는 더미 텍스트만 사용해. 완성된 배너가 아니라 톤·무드·레이아웃 구도만 보여주는 참고용 러프 시안으로 만들어줘.';
