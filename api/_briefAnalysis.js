...
[카피 제안]
- (역할 라벨과 원본 문구를 먼저 쓰고 화살표(→)로 다듬은 대안 카피를 이어서 한 줄에 쓰세요. 형식 예시: 메인카피 "요금제 하나에 싹 다 담았어요" → "디즈니+부터 넷플릭스까지, 요금제 하나로 싹 다!" (원본이 서술형으로 길어 한눈에 안 들어와 축약). 역할 라벨은 originalCopyTranscript에 적은 메인카피/서브카피/부가설명 중 실제로 고치는 것 하나만 쓰고, 왜 고치는지 이유도 괄호 안에 짧게 덧붙이세요. 1~2개까지만 제시하고, 기획 의도와 제작 방향은 그대로 유지한 채 표현만 다듬는 카피라이팅에 그치세요. 원본의 의미나 소재를 새로 지어내지 마세요)
