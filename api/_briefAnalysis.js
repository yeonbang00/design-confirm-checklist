...
- creativeDirection: 실제로 어떻게 디자인하면 좋을지, 아래 형식을 그대로 지켜서 체계적으로 작성하세요. 대괄호로 시작하는 헤더 줄과 "- "로 시작하는 항목들로 구성하고, 섹션 사이는 빈 줄로 구분하세요:

[톤앤무드]
- (이 기획 의도에 어울리는 분위기·인상을 2~3개, 왜 그런지 근거와 함께)
