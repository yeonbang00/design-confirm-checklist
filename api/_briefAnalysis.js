...
[비주얼 제안]
- (기획안에 참고 이미지가 포함되어 있다면 그 레퍼런스를 그대로 따르라고 하지 말고, 그걸 참고하되 이 배너 목적에 맞게 실제로 어떻게 구성하면 좋을지 독립적인 제안을 하세요 — 구도, 이미지 소재 선택, 색감·보정 방향, 요소 배치 우선순위 중 이 기획안에 실제로 필요한 것 위주로 2~4개, 구체적인 근거와 함께. 레퍼런스가 없거나 방향이 이미 적절하다면 이 기획 의도에 가장 잘 맞는 비주얼 구성을 처음부터 제안하세요)
