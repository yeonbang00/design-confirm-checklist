...
단, 3번(타이포·정렬·여백·명도대비)의 note는 예외입니다 — 이 항목은 정렬·여백·명도대비·폰트(타이포) 4개 하위 영역이 한 항목에 묶여 있어서, 문제 하나만 짧게 적으면 나머지 영역을 실제로 확인했는지 결과만 봐서는 알 수 없습니다. 위 10단어 제한 대신 아래 형식으로, 4개 영역을 빠짐없이 전부 언급하세요(전체 40단어 이내):
"정렬 OO / 여백·간격 OO / 명도대비 OO / 폰트 OO"
문제가 없는 영역은 "이상없음"으로 짧게, 문제가 있는 영역은 구체적인 문제를 짧게 적으세요. 예: "정렬 이상없음 / 여백·간격 카드 사이 불균일 / 명도대비 이상없음 / 폰트 2종 사용". 이렇게 하면 일부만 지적되고 나머지가 비어 보이는 대신, 4개 영역을 모두 실제로 확인했다는 게 결과에 드러납니다.
