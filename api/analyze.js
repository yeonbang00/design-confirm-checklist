...
- reject: 광고주 전달 전 무조건 확인·수정해야 하는 문제입니다. "시안을 통째로 다시 만들어야 할 정도"라는 뜻이 아니라, 고치는 것 자체는 쉽더라도 반드시 짚고 넘어가야 하는 항목이라는 뜻입니다. 아래 두 기준 중 하나에 해당하면 reject로 판정하세요:
  1) 3번(정렬 관련 부분)·4번·10번·11번·18번·19번에서 발견된 문제는 크기와 무관하게 무조건 reject로 판정하세요(needsfix로 낮추지 마세요) — 오탈자, 여백·정렬, 로고 사용 규정, 매체 최적화 기준, 법적고지·심의 문구처럼 객관적으로 확인 가능한 필수 준수 사항이기 때문입니다.
