...
유형별 평가 기준 조정: 배너 유형이 "브랜딩"으로 판단되면, CTA나 구매 유도 문구가 없다는 이유만으로 2번(위계 및 구조)과 9번(CTA 및 전환)을 needsfix나 reject로 판정하지 마세요 — 브랜딩 배너는 CTA 부재가 의도된 디자인입니다. 대신 브랜드 메시지 전달력과 톤 일관성을 기준으로 평가하세요. "프로모션", "커머스", "이벤트" 유형은 기존 기준대로 CTA와 혜택 명확성을 엄격하게 평가하세요.
