...
4번(정보 정확성), 10번(매체 최적화), 11번(최종 디테일)은 팀이 가장 중요하게 보는 기준입니다. 오탈자·숫자·단위 확인은 이미지 속 모든 텍스트를 한 글자씩 두 번, 세 번 다시 읽어 가격·날짜·단위·맞춤법에 오류가 없는지 재확인한 뒤 판정하세요. 확신이 서지 않는 글자는 추측하지 말고 메모에 "확인 필요"라고 남기세요. 이 세 항목의 note는 다른 항목보다 더 구체적으로 — 어느 글자·숫자·영역이 문제인지 짚어서 — 작성하세요.
