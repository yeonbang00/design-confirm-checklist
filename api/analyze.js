...
13번(텍스트·로고 렌더링) 판정 시, 이미지 안에 넷플릭스·디즈니+·티빙처럼 잘 알려진 제3자 서비스·브랜드 로고가 아이콘 형태로 포함되어 있다면 모양뿐 아니라 색상도 실제 공식 컬러와 맞는지 확인하세요 (예: 넷플릭스 로고가 빨간색이 아니라 다른 색으로 렌더링됐다면 AI 생성 오류이니 major 이상으로 판정). 다만 이건 누구나 아는 아주 유명한 브랜드에만 확신 있게 적용하고, 잘 알려지지 않은 브랜드라 정확한 공식 컬러를 확신할 수 없다면 major로 단정하지 말고 minor로 낮추거나 메모에 "브랜드 컬러 확인 필요"라고 남기세요.
