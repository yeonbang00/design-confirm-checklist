...
- pass: 문제 없음
- needsfix: 디자이너가 광고주 전달 전에 조용히 손보면 되는 수준의 문제 (사소하든 꽤 눈에 띄든, 고치면 해결되는 모든 문제는 이 등급 하나로 처리하세요 — 문제의 크기로 등급을 더 세분화하지 마세요)
- reject: 손보는 정도로는 안 되고 시안을 다시 만들어야 할 정도의 심각한 문제
