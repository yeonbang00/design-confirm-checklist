...
export const CHECKLIST_ITEMS = [
  ...
  {
    id: 'usp_differentiator_present',
    section: 'usp',
    label: '할인·특가 위주로만 치우치지 않고 제품·브랜드 고유의 특징·차별점이 드러남',
    promptText: '배너가 할인율·특가 등 프로모션 소구에만 치중되어 있지 않고, 이 제품·브랜드만의 고유한 특징이나 차별점(성분, 효과, 기술, 품질 등)이 카피나 비주얼에 명확히 드러나야 한다. 할인 정보만 강조되고 제품 고유의 차별점이 전혀 언급되지 않거나, 언급되더라도 너무 작게 묻혀 있어 눈에 띄지 않는 경우를 지적한다 (예: 세일 배너인데 정작 이 제품이 왜 좋은지는 어디에도 안 보이는 경우).',
  },
  {
    id: 'usp_tone_positioning_match',
    section: 'usp',
    label: '브랜드 포지셔닝에 맞는 소구 방식 사용 (프리미엄인데 초특가 느낌 등 불일치 금지)',
    promptText: '이 브랜드의 포지셔닝(프리미엄/가성비 등)에 맞지 않는 소구 방식을 쓰지 않아야 한다. 프리미엄·전문성을 지향하는 브랜드인데 "초특가", "땡처리"처럼 저가 이미지를 주는 표현을 과도하게 쓰거나, 반대로 가성비가 핵심인 브랜드인데 가격 경쟁력이 전혀 안 보이는 경우를 지적한다.',
  },
  {
    id: 'usp_value_over_discount_hierarchy',
    section: 'usp',
    label: '할인 정보의 시각적 비중이 제품 가치 메시지를 압도하지 않음',
    promptText: '할인율·가격 등 프로모션 요소가 시각적으로 지나치게 크거나 지배적으로 배치되어, 제품의 고유 가치·차별점을 담은 메시지가 상대적으로 위축되거나 안 보이지 않아야 한다.',
  },
  {
    id: 'avoid_collage',
    section: 'quality',
