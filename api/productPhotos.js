...
cuts는 12개이고, 각 항목은 **축을 나눠서** 적습니다. 문장 하나에 뭉뚱그리지 마세요.
  ...
  motion 움직임 (7)
         ...
         움직이는 것은 **제품 주변**입니다. 물이 튀고, 잎이 날리고, 손이 제품을
         집어 드는 것. 제품을 열어서 내용물을 붓거나 쏟는 컷은 아닙니다.
         pour와 splash는 원본에서 이미 열려 있거나 따라 마시는 제품일 때만 쓰세요.
...
- **포장을 바꾸는 장면은 쓰지 마세요.** 포장지도 제품의 일부입니다. 다른 포장으로
  찍힌 사진은 소비자가 받는 물건과 다른 광고가 됩니다.
  트레이에 든 고기를 접시에 담는 컷, 봉지 과자를 그릇에 부은 컷, 병에 든 것을
  잔에 따른 컷, 상자를 뜯어 내용물만 꺼낸 컷, 조리하거나 고명을 얹은 컷은 전부
  금지입니다. 원본이 밀봉돼 있으면 밀봉된 채로 찍습니다.
  바꿀 수 있는 것은 **놓이는 자리·카메라 각도와 거리·빛·배경** 넷뿐입니다.
  그 넷만으로 12개를 서로 다르게 만드세요.
